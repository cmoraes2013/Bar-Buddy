...
module.exports = function(app) {
  ...
  app.get("/api/brand", function(req, res) {
    ...
    //
      ...
      // Let's go find the brand in a join so we 
      // will also get any reviews.
      // let brandName = req.body.bevName.toUpperCase();
      // let brandName = req.body.bevName;
      let brandName = 'SINGLECUT BEERSMITHS 19-33 PILSNER';
      ...
      db.Brands.findOne({
        ...
        include: [db.Reviews]
      }).then(function(dbBrandReviews) {
        if (!dbBrandReviews) {

        } else {
          res.json(dbBrandReviews);
        }
      });
    // }
  });
